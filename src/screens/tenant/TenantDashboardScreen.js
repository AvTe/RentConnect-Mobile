    ...
    const promoSlides = [
        {
            ...
            subtitle: 'Explore premium listings in Nairobi, Mombasa, Kisumu & more',
            gradient: ['rgba(0,0,0,0.6)', 'rgba(0,0,0,0.35)', 'rgba(254,146,0,0.35)'],
        },
        {
            id: 2,
            tag: 'HOT DEALS',
            title: 'Special Offers This Month',
            subtitle: 'Get up to 50% off on first month rent in selected properties',
            gradient: ['rgba(0,0,0,0.6)', 'rgba(0,0,0,0.35)', 'rgba(139,92,246,0.35)'],
        },
        {
            id: 3,
            tag: 'NEW ARRIVALS',
            title: 'Premium Apartments',
            subtitle: 'Luxury living spaces now available in Westlands & Kilimani',
            gradient: ['rgba(0,0,0,0.6)', 'rgba(0,0,0,0.35)', 'rgba(16,185,129,0.35)'],
        },
    ];
